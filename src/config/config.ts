...
export const languageLabels = Object.values(languageOption).map(
  (option) => option.label,
);
...
export const CONFIG: Config = {
  jakarta: {
    title: "Jakarta",
    information:
      "Join Inarah as she takes you on her journey in Jakarta. You will witness outcomes that mirror or contradict each other, depending on the route that you take: Pasar Baru or Lapangan Banteng (or both!). Depending on your choices, the protagonist may encounter robbery or cross paths with a benign snack vendor. These diverging narratives highlight how small decisions can lead to vastly different destinies.",
    credits: [
      ["Inarah Syarafina", "Protagonist", "inarah.syarafina"],
      ["Elena Natanael", "Creative, Friend", "elena.natanael"],
      ["Bimo Deviantoputra", "Pickpocket, Meatball Vendor", "bimodvnt"],
  ...
  "hong-kong": {
    ...
    information:
      "Join Inarah as she takes you on her journey in Jakarta. You will witness outcomes that mirror or contradict each other, depending on the route that you take: Pasar Baru or Lapangan Banteng (or both!). Depending on your choices, the protagonist may encounter robbery or cross paths with a benign snack vendor. These diverging narratives highlight how small decisions can lead to vastly different destinies.",
    credits: [
      ["Angela Liu", "Carousell Seller", "angelaliuuu"],
      ["Kim", "Carousell Buyer", "shut_up_and_dance"],
    ],
  ...
  singapore: {
    ...
    languageOptions: ["en"],
    credits: [
      ["Ariel Sjarifuddin", "Fighter", "healthycalculus"],
      ["Elizabeth Kezia", "Enemy", "ekezia"],
    ],
  ...
  cambodia: {
    ...
    languageOptions: ["en"],
    credits: [
      ["Claudia Park", "Mockumentary Reporter", "parkladizharbo"],
      ["Elizabeth Kezia", "Cameraman", "ekezia"],
    ],
    ...
    arrows: {
      ...
      10: [
        ["up", 1, "Go up"],
        ["down", -6, "Go back to hotel stairs"],
      ],
      11: [
        ["reverse", 1, "Forward"],
        ["down", -1, "Go back down"],
      ...
      31: [
        ["reverse", 1, "Forward"],
        ["left", -1, "Back to water tower"],
      ],
      32: [
        ["left", 1, "Forward to Kings Palace"],
        ["right", -1, "Back to water tower"],
      ],
      33: [
        ["reverse", 1, "Forward to Kings Palace"],
        ["forward", -1, "Back"],
      ],
      34: [
        ["reverse", 1, "Forward"],
      ...
      44: [
        ["reverse", 1, "Go to the chamber"],
        ["forward", 48, "Back"],
      ],
      45: [
        ["reverse", 1, "Go to the kitchen"],
        ["forward", -1, "Back"],
      ],
      46: [
        ["right", 1, "Jump out the window"],
        ["left", -1, "Back"],
      ],
      47: [
        ["reverse", 1, "Go to the mushroom"],
        ["left", -1, "Back to the house"],
        ["forward", 18, "Towards hotel"],
        ["right", -16, "To water tank"],
      ],
      48: [
        ["reverse", 1, "Forward"],
        ["forward", -1, "Back"],
      ...
      49: [
        ["up", 1, "Go up the mushroom"],
        ["forward", -1, "Back"],
      ],
      50: [
        ["reverse", 1, "Go out of the monument"],
        ["forward", -1, "Back"],
      ],
      51: [
        ["left", 5, "To the road"],
      ...
      54: [
        ["forward", -1, "Back"],
        ["reverse", 1, "Go to the road"],
        ["left", 17, "Go to the house"],
      ],
      55: [
        ["reverse", 1, "Forward"],
        ["forward", 2, "Back"],
      ...
      56: [
        ["left", 32, "Go to temple"],
        ["reverse", 1, "Go to railway station"],
        ["right", 35, "Go to Truman Show"],
      ],
      57: [
        ["left", -2, "Forward"],
        ["right", -1, "Back"],
        ["down", 22, "Jump down the water"],
      ],
      // boat is at 79
      58: [
        ["reverse", 1, "Forward"],
        ["forward", 21, "Back to boat"],
      ],
      59: [
        ["reverse", 1, "Forward"],
        ["forward", -1, "Back"],
      ...
      65: [
        ["reverse", -18, "Back to mushroom"],
        ["forward", 1, "Go towards gate"],
        ["left", -9, "Back to railway station"],
        ["right", -1, "To church"],
      ],
      66: [
        ["right", -1, "Back"],
      ...
      67: [
        ["reverse", -1, "Back to gate"],
        ["forward", 1, "Go towards hotel"],
      ],
      68: [
        ["forward", -1, "Back"],
        ["reverse", 1, "Forward"],
      ...
      74: [
        ["right", 1, "Forward"],
        ["down", -1, "Back to the darkroom"],
        ["reverse", 3, "Fall"],
      ],
      75: [
        ["down", -2, "Back to the darkroom"],
        ["forward", -1, "Back"],
      ],
      ...
      77: [
        ["left", -63, "Forward"],
        ["up", -1, "Back to the drunk"],
      ],

      79: [
        ["up", -22, "Back up"],
        ["right", -21, "Another island"],
        ["left", 1, "Island"],
      ],
      ...
      86: [
        ["reverse", 8, "More luxury?"],
        ["left", -2, "Back"],
        ["down", 1, "Down the pool"],
      ],
      87: [
        ["up", -1, "Go back up"],
        ["down", 1, "Go deeper"],
      ...
      88: [
        ["up", -1, "Go back up"],
        ["reverse", 1, "Temple"],
        ["left", -32, "Back to railway station"],
      ],
      89: [
        ["forward", -1, "Back"],
        ["reverse", 1, "Forward"],
      ...
      90: [
        ["up", -1, "Back"],
        ["reverse", 11, "Fall again"],
      ],

      91: [
        ["reverse", -5, "Experience the Chinese developer luxury"],
        ["forward", -35, "Back to the road"],
      ],
      92: [
        ["reverse", -48, "Forward"],
        ["forward", -1, "Back"],
      ...
      93: [
        ["right", 6, "Back"],
        ["reverse", -17, "Exit door"],
      ],

      94: [
        ["reverse", -4, "Jump to cliff"],
        ["forward", 1, "Back"],
      ],
      95: [
        ["reverse", -26, "Go towards the hotel"],
        ["forward", -1, "Go to the balcony"],
      ],
      ...
      98: [
        ["reverse", -93, "Forward"],
        ["left", 1, "Towards other room"],
        ["right", 6, "Go out"],
      ],
      99: [
        ["reverse", -2, "Other room"],
        ["forward", -1, "Back"],
      ],

      100: [
        ["reverse", -2, "Go in the house"],
        ["left", -13, "To lake"],
      ],
      101: [
        ["reverse", 1, "Forward"],
        ["forward", -1, "Back"],
        ["down", -84, "Down to another circle"],
      ],
      102: [
        ["reverse", 1, "Forward"],
        ["forward", -1, "Back"],
